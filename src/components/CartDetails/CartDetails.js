...
const CartDetails = () => {
  ...
  const { url, price, title, details, author, name, ratings, students, video } =
    courseDetails;
  ...
  return (
    <div className="mt-20 " >
      ...
      <DownloadPage roofElementId="pageToDownload" downloadFileName={name}></DownloadPage>
      </div>
      ...
      <div id="pageToDownload" className="mt-20">
        ...
        <div className="w-11/12 mx-auto">
          ...
          <h2 className="card-title text-5xl mb-10 font-bold mx-auto text-center">{name}</h2>
