    ...
    <div className="mt-20">
      ...
      <div className="lg:flex w-11/12 mx-auto">
        ...
        <div className="lg:w-2/6">
          <h3 className="text-3xl text-center lg:text-left font-bold mb-6 whiteColor">
            Course List
          </h3>
          ...
          {courses.map((course) => (
            <Link key={course.id} to={`/cartdetails/${course.id}`}>
              <div
                className="text-xl font-bold mt-2 shadow-md text-center lg:text-left py-2 whiteColor"
              >
                {course.name}
              </div>
            </Link>
